...
import MediaProviderModels from "./components/MediaProviderModels";
import MediaProviderUsage from "./components/MediaProviderUsage";
...
export default function MediaProviderPageClient({ kind, id }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <MediaProviderHeader
        ...
        provider={provider}
        isCustom={isCustom}
        customPrefix={customNode?.prefix}
        kinds={kinds}
      ...
      <MediaProviderUsage
        ...
        isCustom={isCustom}
        customAlias={customNode?.prefix}
        hasGenericExample={!!KIND_EXAMPLE_CONFIG[kind]}
        EmbeddingExampleCard={EmbeddingExampleCard}
        TtsExampleCard={TtsExampleCard}
        SttExampleCard={SttExampleCard}
        GenericExampleCard={GenericExampleCard}
      />
