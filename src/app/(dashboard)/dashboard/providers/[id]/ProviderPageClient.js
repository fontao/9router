...
import ProviderEndpoints from "./components/ProviderEndpoints";
...
export default function ProviderPageClient({ providerId }) {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:gap-8 sm:px-0">
      ...
      <ProviderModels
        ...
        renderModelsSection={renderModelsSection}
      />
